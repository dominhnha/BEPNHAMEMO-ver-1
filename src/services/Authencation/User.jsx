...
//PurchaseHistory
export const AddPurchaseHistoryForUser = async(uid,Cart = [{pid:"",quantity:""}],status={user:true,discount:true},Total ) =>{ 
    ...
    else if(status.discount===true || status.discount===null){
